    ...
    return (
        <div className="Tab1">
            ...
            <main className="Tab1Main">
                <img className="PokeLogo" src="http://pm1.narvii.com/6246/fcdf34bae5d56632c6b147e067c8d7443e737323_00.jpg" alt="pokemon logo" />

                <h3 className="Paragraph">Mysterious Creatures You Catch with a Poké Ball</h3>
                <p>
                ...
                <hr />
                <h3 className="Paragraph">How many kinds of Pokémon are there?</h3>
                <p>
                ...
                <hr />
                <h3 className="Paragraph">Pokémon grow stronger through battle</h3>
                <p>
                ...
                <hr />
                <h3 className="Paragraph">There are many types of Pokémon</h3>
                <p>
                ...
                <hr />
                <h3 className="Paragraph">The TV Anime series and movies</h3>
                <p>
